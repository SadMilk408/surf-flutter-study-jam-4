...
class $AssetsAudioGen {
  ...
  /// File path: assets/audio/fail.mp3
  String get fail => 'assets/audio/fail.mp3';

  /// File path: assets/audio/good.mp3
  String get good => 'assets/audio/good.mp3';

  /// List of all assets
  List<String> get values => [fail, good];
}
