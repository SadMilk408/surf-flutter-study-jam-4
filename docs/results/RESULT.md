...
UPD: После окончания джема, было добавлено:
7. Доработана анимация шара, добавлена тряска при запросе
8. Добавлена анимация появления текста
9. Адаптивное поведение шара при изменении размеров экрана
10. Перевод текста ответа с api
11. Добавлено воспроизведение звука после (не)удачного запроса
12. Реализованы настройки включающие - смену темы, изменение цвета шара, изменение скорости анимации полета шара, изменение кривой анимации шара
...
После рефакторинга было принято решение использовать хуки из одноименной библиотеки flutter_hooks, useAnimationController оказался довольно приятным в работе с анимациями
<p align="center"><img width="497" alt="Снимок экрана 2023-08-04 в 23 23 48" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/11873d25-453d-4698-b0f8-6eb566415d25"></p>
...
Была использована библиотека animated_text_kit и создан отдельный виджет для анимированного текста, также используем функцию для разбиения текста на слова для выплывания каждого по отдельности
<p align="center"><img width="419" alt="Снимок экрана 2023-08-04 в 23 29 45" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/968b082d-81a6-4f3c-aed0-dd47b9706f1e"></p>

### Адаптивность

Добавление адаптивности было не простой задачей и было испробовано несколько подходов, в итоге выбор пал на использование LayoutBuilder'а и функции с указанием размера для элементов которые описаны в enum
<p align="center"><img width="594" alt="Снимок экрана 2023-08-04 в 23 33 14" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/4e851906-503c-44f8-99de-3c4e0fbd75c1">
<img width="477" alt="Снимок экрана 2023-08-04 в 23 33 32" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/c65e7f89-cd89-4dfe-89ee-4f4525e54885"></p>

### Перевод текста

Использована библиотека translator. Далее пример использования для перевода данных с api: 
<p align="center"><img width="576" alt="Снимок экрана 2023-08-04 в 23 37 48" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/eb734187-eab3-449c-9296-6a821aa12023"></p>

### Озвучивание статуса запросов

Используем библиотеку just_audio и из предварительно добавленных ассетов выбираем нужный файл для вопроизведения
<p align="center"><img width="326" alt="Снимок экрана 2023-08-04 в 23 40 26" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/d0f40436-3adc-4354-91f6-c46e5486d02a"></p>

### Настройки
Для управления настройками предварительно создаем класс с необходимыми для настройки параметрами и создаем StateProvider для управления состоянием
<p align="center"><img width="568" alt="Снимок экрана 2023-08-04 в 23 44 24" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/77a87825-fcd0-4fbe-b85b-e74b145fd9b9"></p>

Затем поочередно создаем виджеты для каждой отдельной настройки, в итоге получаем общий список:
<p align="center"><img width="352" alt="Снимок экрана 2023-08-04 в 23 46 59" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/1631da9f-524d-403c-9742-ab444e7aca9e"></p>

Не будем рассматривать все имеющиеся виджеты настроек, в качестве примера изменения состояния можно рассмотреть изменение скорости полета шара: 
<p align="center">img width="399" alt="Снимок экрана 2023-08-04 в 23 48 14" src="https://github.com/SadMilk408/surf-flutter-study-jam-4/assets/72536608/788427f1-f383-412c-a00b-9ae947122536"></p>
Так как состояние в провайдере хранит класс с final полями, нам просто необходим метод copyWith, с помощью которого мы безболезнено заменяем необходимые поля и наше состояние обновляется.
...
UPD: Все произведенные доработки отражены в коммитах, все было выполнено в желании приблизиться к конечному результату продукта который был запрошен по ТЗ, доработка и рефакторинг проекта принесли не меньшее удовольствие чем начальный его вариант, многие фичи были вдохновленны работами других участников, круто видеть интересные идеи и пытаться реализовывать их по своему :)
